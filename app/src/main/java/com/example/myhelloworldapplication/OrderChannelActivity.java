...
public class OrderChannelActivity extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title.setText("Sunshine Cafe ");
    }
        ...
        for (; i < goodsArray.size(); i++) {
            ...
            btn_add.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(OrderChannelActivity.this,
                            "has added a " + info.name + " into your order", Toast.LENGTH_SHORT).show();
                }
            });
