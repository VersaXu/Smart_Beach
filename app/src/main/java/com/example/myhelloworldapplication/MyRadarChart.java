...
public class MyRadarChart extends RadarChart{
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            RadarDataSet dataSetByIndex = (RadarDataSet) getData().getDataSetByIndex(highlight.getDataIndex());
            // check bounds
...
//            mRoundMarker.draw(canvas, pos[0] - mRoundMarker.getWidth() / 2, pos[1] + circleRadius - mRoundMarker.getHeight());
            mRoundMarker.draw(canvas, pos[0] - mRoundMarker.getWidth() / 2, pos[1] - mRoundMarker.getHeight());
        }
    }
}
